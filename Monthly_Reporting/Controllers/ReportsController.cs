...
namespace Monthly_Reporting.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public ActionResult ExeLoanStatment(Reports re)
        {
            ...
            else
            {
                if (Session["ID"] != null)
                {
                    ...
                    ----------------------------------------------
                    set @Reportfrom = '" + string.Format("{0:yyyy-MM-dd}", datestart) + @"'
                    set @Reportto = '" + string.Format("{0:yyyy-MM-dd}", dateend) + @"'
        ...
        [HttpPost]
        public ActionResult ExecSummaryByCos(Reports re)
        {
            DataTable dt = new DataTable();
            DataTable dt_main_menu = new DataTable();
            DataTable dtRun = new DataTable();
                ...
                if (Session["ID"] != null)
                {
                    ...
                    if (All == "on")
                    {
                        Sql = @"
                          ...
                          IF OBJECT_ID('TEMPDB..#LN_DETAIL_PAR') IS NOT NULL
								DROP TABLE #LN_DETAIL_PAR
							select 
				                row_number() over(order by Acc) as ID,
				                @BrCode as BrCode,
				                @BrShort as BrShort,
                            ...
                            select 
				                row_number() over(order by l1.BrCode) as ID,
								l1.BrCode,
				                l1.BrShort,
								l1.CoNameKh,
								(select count(l.AccountNumber) from #LN_DETAIL_PAR l where l.IdCo=l1.IdCo and l.BrCode=l1.BrCode and l.Ageofloan>=15) as TotalAccPAR15,
                                (select sum(l.Balamt) from #LN_DETAIL_PAR l where l.IdCo=l1.IdCo and l.BrCode=l1.BrCode and l.Ageofloan>=15) as TotalPar15,
								(select sum(l.Balamt) from #LN_DETAIL_PAR l where l.IdCo=l1.IdCo and l.BrCode=l1.BrCode and l.Ageofloan>=15)/sum(l1.Balamt) as Par15,
								(select count(l.AccountNumber) from #LN_DETAIL_PAR l where l.IdCo=l1.IdCo and l.BrCode=l1.BrCode and l.Ageofloan>=30) as TotalAccPAR30,
								(select sum(l.Balamt) from #LN_DETAIL_PAR l where l.IdCo=l1.IdCo and l.BrCode=l1.BrCode and l.Ageofloan>=30)/sum(l1.Balamt) as Par30,			                			              
				                (select sum(l.Balamt) from #LN_DETAIL_PAR l where l.IdCo=l1.IdCo and l.BrCode=l1.BrCode and l.Ageofloan>=30) as TotalPar30,			                			              
				                l1.Reportdate				                   
				                from #LN_DETAIL_PAR l1
								group by 
								l1.BrCode,
				                l1.BrShort,
								l1.IdCo,
								l1.CoNameKh,l1.Reportdate
                    ...
                    if (re.download == "download")
                    {
                        string ReportName = "Summary By Cos Reports";
                        string BrName = Convert.ToString(mutility.dbSingleResult("select BrLetter from BRANCH_LISTS where flag=1 and BrCode='" + re.BrCode + "'"));
                        ExportDataToExcel(downloadLoanStatement, BrName + "_" + ReportName);
                    }


                    return View("SummaryByCos");
                }
                else
                {
                    return RedirectToAction("Index", "Login/Index");
        ...
        [HttpPost]
        public ActionResult ExecSummaryByBranch(Reports re)
        {
            DataTable dt = new DataTable();
            DataTable dt_main_menu = new DataTable();
            DataTable dtRun = new DataTable();
            ...
            else
            {
                if (Session["ID"] != null)
                {
                        ...
                        Sql = @"
                          ...
                          IF OBJECT_ID('TEMPDB..#LN_DETAIL_PAR') IS NOT NULL
                            ...
                            select 
								...
								(select count(l.AccountNumber) from #LN_DETAIL_PAR l where l.BrCode=l1.BrCode and l.Ageofloan>=15) as TotalAccPAR15,
                                (select sum(l.Balamt) from #LN_DETAIL_PAR l where  l.BrCode=l1.BrCode and l.Ageofloan>=15) as TotalPar15,
								(select sum(l.Balamt) from #LN_DETAIL_PAR l where l.BrCode=l1.BrCode and l.Ageofloan>=15)/sum(l1.Balamt) as Par15,
								(select count(l.AccountNumber) from #LN_DETAIL_PAR l where l.BrCode=l1.BrCode and l.Ageofloan>=30) as TotalAccPAR30,
								(select sum(l.Balamt) from #LN_DETAIL_PAR l where l.BrCode=l1.BrCode and l.Ageofloan>=30)/sum(l1.Balamt) as Par30,			                			              
				                (select sum(l.Balamt) from #LN_DETAIL_PAR l where  l.BrCode=l1.BrCode and l.Ageofloan>=30) as TotalPar30,			                			              
				                l1.Reportdate				                   
				                from #LN_DETAIL_PAR l1
								group by 
								l1.BrCode,
                    ...
                    if (re.download == "download")
                    {
                        string ReportName = "Summary By Branch Reports";
                        string BrName = Convert.ToString(mutility.dbSingleResult("select BrLetter from BRANCH_LISTS where flag=1 and BrCode='" + re.BrCode + "'"));
                        ExportDataToExcel(downloadLoanStatement, BrName + "_" + ReportName);
                    }


                    return View("SummaryByBranch");
                }
                else
                {
                    return RedirectToAction("Index", "Login/Index");
                ...
                if (Session["ID"] != null)
                {
                    ...
                    string Sql = @"	/*
	                        ...
	                        */	
	                        ...
	                        ---------------------------------------------------------------------------------
	                        set @DateFrom = '"+ string.Format("{0:yyyy-MM-dd}", datestart) + @"'
	                        set @DateTo = '"+ string.Format("{0:yyyy-MM-dd}", dateend) + @"'
                            ---------------------------------------------------------------------------------	
	                        /*
	                        CLEAN TEMP TABLE
	                        */
                ...
                if (Session["ID"] != null)
                {
                    ...
                    Sql = @"	
                        ...
                        select 
		                        ...
		                        where l.accstatus between '11' and '98' and co.Createdate between '" + string.Format("{0:yyyy-MM-dd}", datestart) +"' and '"+ string.Format("{0:yyyy-MM-dd}", dateend) +"'";
                    }
                    else
                    {
                        Sql = @"	
                        ...
                        select 
		                        ...
		                        where l.accstatus between '11' and '98' and l.Acc+l.chd='"+re.accountnumber+"' and co.Createdate between '" + string.Format("{0:yyyy-MM-dd}", datestart) + "' and '" + string.Format("{0:yyyy-MM-dd}", dateend) + "'";
            ...
            else
            {
                ...
                */
                ...
                --set @FullTitle=0
                    ...
                    if (re.download == "download")
                    {
                        string ReportName = "List​ off WrittenOff Reports";
                        string BrName = Convert.ToString(mutility.dbSingleResult("select BrLetter from BRANCH_LISTS where flag=1 and BrCode='" + re.BrCode + "'"));
                        ExportDataToExcel(downloadLoanStatement, BrName + "_" + ReportName);
                    }
                    ...
                    if (All == "on")
                    {
                        ...
                        select 
	                        ...
	                        c.Reff	
	                         ...
	                         where CollectDate between '" + string.Format("{0:yyyy-MM-dd}", datestart) + "' and '" + string.Format("{0:yyyy-MM-dd}", dateend) + "'";
                    }
                    else
                    {
                        Sql = @"	
                        ...
                        select 
	                        ...
	                        c.Reff	
	                         from [dbo].[VTSDxWOCollection] c inner join [dbo].[SKP_Brlist] s on c.BrCode=s.SubBranchCode
	                         where c.Acc='"+re.accountnumber+"' and c.CollectDate between '" + string.Format("{0:yyyy-MM-dd}", datestart) + "' and '" + string.Format("{0:yyyy-MM-dd}", dateend) + "'";
